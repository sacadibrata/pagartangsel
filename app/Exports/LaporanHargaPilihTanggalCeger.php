...
class LaporanHargaPilihTanggalCeger implements FromView
{
    protected $startDate;
    protected $endDate;
    ...
    public function view(): View
    {
        ...
        $komoditas = KomoditasCeger::whereHas('pendataanceger', function ($query) {
        ...
        return view('backend.pasar_ceger.export.laporanhargatanggalceger', [
