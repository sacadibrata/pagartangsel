...
class PendataanPsCimanggisImport implements ToModel, WithHeadingRow
{
    ...
    */
    ...
    public function model(array $row)
    {
        ...
        $komoditas = KomoditasCimanggis::firstOrCreate(['nama_komoditas' => $komoditasName]);

        return new PendataanPsCimanggis([
