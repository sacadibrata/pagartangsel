...
class PendataanPsJengkolImport implements ToModel, WithHeadingRow
{
    ...
    */
    ...
    public function model(array $row)
    {
        ...
        $komoditas = KomoditasJengkol::firstOrCreate(['nama_komoditas' => $komoditasName]);

        return new PendataanPsJengkol([
