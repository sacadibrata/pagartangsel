...
class PendataanPsJombangImport implements ToModel, WithHeadingRow
{
    ...
    */
    ...
    public function model(array $row)
    {
        ...
        $komoditas = KomoditasJombang::firstOrCreate(['nama_komoditas' => $komoditasName]);

        return new PendataanPsJombang([
