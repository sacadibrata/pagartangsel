...
class PendataanPsSerpongImport implements ToModel, WithHeadingRow
{
    ...
    */
    ...
    public function model(array $row)
    {
        ...
        $komoditas = KomoditasSerpong::firstOrCreate(['nama_komoditas' => $komoditasName]);

        return new PendataanPsSerpong([
