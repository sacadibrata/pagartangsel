                ...
                <div class="row mb-8">
                    <div class="col-md-12">
                        ...
                        <div class="card bg-light border-0 rounded-4"
                            style="background-image: url({{ asset('dist/assets/images/slider/slider-image-1.jpg') }}); background-repeat: no-repeat; background-size: cover; background-position: right;">
