        ...
        <div class="header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" style="text-transform: capitalize;"><a href="{{route('datasurveyor.edit',$data->id)}}">Form Edit Surveyor</a></li>
                </ol>
            </nav>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('datasurveyor.update',$data->id) }}" method='post' id="validation-form">
                            @csrf
                            @method('PUT')
                            <div class="mb-3 error-placeholder">
                                <label class="form-label" for="user_id">Surveyor</label>
                                <div class="d-flex">
                                    <select class="form-control" name="user_id" id="user">
                                        <option value="">Pilih Kota</option>
                                        @foreach ($surveyorUsers as $item)
                            ...
                            <div class="mb-3 error-placeholder">
                                ...
                                <div class="d-flex">
                                    <select name="kecamatan_id" id="kecamatan" class="form-control">
                                        @foreach($kecamatans as $subcategory)
