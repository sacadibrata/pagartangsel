                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('pendataanAll.indexCimanggis') }}" class="text-inherit">List Price Product</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Add New Price</li>
                            </ol>
                        </nav>
                    </div>
                    <div>
                        <a href="{{ route('pendataanAll.indexCimanggis') }}" class="btn btn-outline-secondary mb-2">Back to List Price</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12 col-12">
                ...
                <div class="card mb-6 shadow border-0">
                    ...
                    <div class="card-body p-6 ">
                        ...
                        @endif
                        <form action="{{ route('importDataPsCimanggis') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-lg-12">
                                    ...
                                    <div class="d-flex">
                                        <select class="form-control" name="pasar_id" id="pasar_cimanggis" style="width: 100%">
                                ...
                                <div class="mb-3 col-lg-12">
                                    ...
                                    <div class="d-flex">
                                        <select name="surveyor_id" id="surveyor_cimanggis" class="form-control">
                                            <option value="">Choose</option>
                                        </select>
                                    </div>
                                </div>
...
<script>
    $(document).ready(function() {
        $('#pasar_cimanggis').on('change', function() {
            var pasar_cimanggis = $(this).val();
            if (pasar_cimanggis) {
                $.ajax({
                    url: '/get-surveyor-cimanggis/' + pasar_cimanggis,
                    type: 'GET',
                    dataType: 'json',
                    success: function(data) {
                        $('#surveyor_cimanggis').empty();
                        $('#surveyor_cimanggis').append('<option value="">Choose ...</option>');
                        $.each(data, function(key, value) {
                            $('#surveyor_cimanggis').append('<option value="' + value.id_surveyor + '">' + value.nama_user + '</option>');
                        });
                    }
                });
            } else {
