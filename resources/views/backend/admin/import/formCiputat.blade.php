                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('pendataanAll.indexCiputat') }}" class="text-inherit">List Price Product</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Add New Price</li>
                            </ol>
                        </nav>
                    </div>
                    <div>
                        <a href="{{ route('pendataanAll.indexCiputat') }}" class="btn btn-outline-secondary mb-2">Back to List Price</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12 col-12">
                ...
                <div class="card mb-6 shadow border-0">
                    ...
                    <div class="card-body p-6 ">
                        ...
                        @endif
                        <form action="{{ route('importDataPsCiputat') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-lg-12">
                                    ...
                                    <div class="d-flex">
                                        <select class="form-control" name="pasar_id" id="pasar_ciputat" style="width: 100%">
                                ...
                                <div class="mb-3 col-lg-12">
                                    ...
                                    <div class="d-flex">
                                        <select name="surveyor_id" id="surveyor_ciputat" class="form-control">
                                            <option value="">Choose</option>
                                        </select>
                                    </div>
                                </div>
...
<script>
    $(document).ready(function() {
        $('#pasar_ciputat').on('change', function() {
            var pasar_ciputat = $(this).val();
            if (pasar_ciputat) {
                $.ajax({
                    url: '/get-surveyor-ciputat/' + pasar_ciputat,
                    type: 'GET',
                    dataType: 'json',
                    success: function(data) {
                        $('#surveyor_ciputat').empty();
                        $('#surveyor_ciputat').append('<option value="">Choose ...</option>');
                        $.each(data, function(key, value) {
                            $('#surveyor_ciputat').append('<option value="' + value.id_surveyor + '">' + value.nama_user + '</option>');
                        });
                    }
                });
            } else {
