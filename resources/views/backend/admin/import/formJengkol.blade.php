            ...
            <div class="col-lg-12 col-12">
                ...
                <div class="card mb-6 shadow border-0">
                    ...
                    <div class="card-body p-6 ">
                        ...
                        @endif
                        <form action="{{ route('importDataPsJengkol') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-lg-12">
                                    ...
                                    <div class="d-flex">
                                        <select class="form-control" name="pasar_id" id="pasar_jengkol" style="width: 100%">
                                ...
                                <div class="mb-3 col-lg-12">
                                    ...
                                    <div class="d-flex">
                                        <select name="surveyor_id" id="surveyor_jengkol" class="form-control">
                                            <option value="">Choose</option>
                                        </select>
                                    </div>
                                </div>
...
<script>
    $(document).ready(function() {
        $('#pasar_jengkol').on('change', function() {
            var pasar_jengkol = $(this).val();
            if (pasar_jengkol) {
                $.ajax({
                    url: '/get-surveyor-jengkol/' + pasar_jengkol,
                    type: 'GET',
                    dataType: 'json',
                    success: function(data) {
                        $('#surveyor_jengkol').empty();
                        $('#surveyor_jengkol').append('<option value="">Choose ...</option>');
                        $.each(data, function(key, value) {
                            $('#surveyor_jengkol').append('<option value="' + value.id_surveyor + '">' + value.nama_user + '</option>');
                        });
                    }
                });
            } else {
