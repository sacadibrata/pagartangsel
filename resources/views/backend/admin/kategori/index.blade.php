      ...
      <div class="row mb-8">
        <div class="col-md-12">
          <div class="d-md-flex justify-content-between align-items-center">
            ...
            <!-- button -->
            <div>
              <a href="{{ route('kategori.create') }}" class="btn btn-outline-primary mb-2">Add New Category</a>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="card-body p-3">
                ...
                <table id="example" class="display nowrap" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$i}}.</td>
                            <td> <a href="{{ asset('kategori/' . $item->gambar_kategori) }}" target="_blank"><img src="{{ asset('kategori/' . $item->gambar_kategori) }}"
