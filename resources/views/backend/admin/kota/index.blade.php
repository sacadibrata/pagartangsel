      ...
      <div class="row mb-8">
        <div class="col-md-12">
          <div class="d-md-flex justify-content-between align-items-center">
            ...
            <!-- button -->
            <div>
              <a href="{{ route('kota.create') }}" class="btn btn-outline-primary mb-2">Add New City</a>
            </div>
          </div>
        </div>
      </div>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <form onsubmit="return confirm('Anda yakin ingin menghapus data Kota {{ $item->nama_kota }}?')" class="d-inline" method="POST" action="{{ route('kota.destroy', $item->id) }}">
                                                @csrf
                                                @method('DELETE')
