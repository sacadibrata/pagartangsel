        ...
        <div class="header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" style="text-transform: capitalize;"><a href="{{ route('pedagang.create') }}">Form Tambah Pedagang</a></li>
                </ol>
            </nav>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action='{{ route('pedagang.store') }}' method='post' id="validation-form">
                            @csrf
                            <div class="mb-3 error-placeholder">
                                <label class="form-label">Nama Pedagang</label>
                                <input type="text" class="form-control" name="nama_pedagang" placeholder="Nama Pedagang ..." value="{{Session::get('nama_pasar')}}">
                            </div>
                            <div class="mb-3 error-placeholder">
