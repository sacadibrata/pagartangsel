        ...
        <div class="col-md-12">
            <div class="d-md-flex justify-content-between align-items-center">
                <!-- pageheader -->
                    ...
                    <!-- button -->
                    <div>
                    <a href="{{ route('importFormPsCeger') }}"
                            ...
                            @foreach ($komoditas as $komoditi)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @include('backend.admin.pendataanAll.priceCegerModal')
                                    </td>
                                    <td>
                                        <a href="{{ route('pendataanAll.showCeger', $komoditi->id) }}" class="btn btn-sm btn-info"><i class="bi bi-info-circle"></i></a>
                                    </td>
                                    <td>
