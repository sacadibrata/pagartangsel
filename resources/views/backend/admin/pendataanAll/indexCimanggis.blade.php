        ...
        <div class="col-md-12">
            <div class="d-md-flex justify-content-between align-items-center">
                <!-- pageheader -->
                    ...
                    <!-- button -->
                    <div>
                    <a href="{{ route('importFormPsCimanggis') }}"
                    target="_blank" rel="noopener noreferrer nofollow" class="btn btn-outline-primary">Import File</a>
                    </div>
            </div>
        </div>
      </div>
                            ...
                            @foreach ($komoditas as $komoditi)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @include('backend.admin.pendataanAll.priceCimanggisModal')
                                    </td>
                                    <td>
                                        <a href="{{ route('pendataanAll.showCimanggis', $komoditi->id) }}" class="btn btn-sm btn-info"><i class="bi bi-info-circle"></i></a>
                                    </td>
                                    <td>
