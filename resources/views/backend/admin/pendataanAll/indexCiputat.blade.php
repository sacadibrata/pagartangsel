        ...
        <div class="col-md-12">
            <div class="d-md-flex justify-content-between align-items-center">
                <!-- pageheader -->
                    ...
                    <!-- button -->
                    <div>
                    <a href="{{ route('importFormPsCiputat') }}"
                        ...
                        <tbody>
                            ...
                            @foreach ($komoditas as $komoditi)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('pendataanAll.showCiputat', $komoditi->id) }}" class="btn btn-sm btn-info"><i class="bi bi-info-circle"></i></a>
                                    </td>
                                    <td>
                                        ...
                                        @include('backend.admin.pendataanAll.priceCiputatModal')
                                    </td>
                                    <td>
