            ...
            <div class="d-md-flex justify-content-between align-items-center">
                <!-- pageheader -->
                    ...
                    <nav aria-label="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">List Price Product</li>
                        </ol>
                    </nav>
                    </div>
                    <!-- button -->
                        ...
                        <tbody>
                            ...
                            @foreach ($komoditasSemuaPasar as $komoditi)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!-- BEGIN primary modal -->
                                        <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#defaultModalPrimary{{ $komoditi->id }}">
                                            <i class="bi bi-pencil-square"></i>
                                        </button>

                                           @include('backend.admin.layout.pendataanHargaSemuaPasarMod')

                                           @include('backend.admin.layout.scriptRataRata')
                                    </td>

                                    <td>
                                        <a href="{{ route('pendataanAll.showSemuaPasar', $komoditi->id) }}" class="btn btn-sm btn-info"><i class="bi bi-info-circle"></i></a>
                                    </td>
                                    <td>
