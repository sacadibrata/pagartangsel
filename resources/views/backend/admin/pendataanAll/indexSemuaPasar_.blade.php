                        ...
                        <div class="table-responsive">
                            <table class="table mb-0">
                                ...
                                <tbody>
                                    ...
                                    @endphp
                                    <?php $i = 1; ?>
                                    @foreach ($komoditasSemuaPasar as $komoditi)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="modal fade" id="defaultModalPrimary{{ $komoditi->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                                                                        ...
                                                                        <div class="row mt-4">
                                                                            <div class="col-md">
                                                                                ...
                                                                                @foreach ($komoditi->pendataanserpong as $hargaBarangSerpong)
                                                                                    @if ($hargaBarangSerpong->tanggal_input == Carbon\Carbon::yesterday()->format('Y-m-d'))
                                                                                        @php
                                                                            ...
                                                                            <div class="col-md">
                                                                                ...
                                                                                @foreach ($komoditi->pendataanciputat as $hargaBarangCiputat)
                                                                                    @if ($hargaBarangCiputat->tanggal_input == Carbon\Carbon::yesterday()->format('Y-m-d'))
                                                                                        @php
                                                                        ...
                                                                        <div class="row mt-4">
                                                                            <div class="col-md">
                                                                                ...
                                                                                @foreach ($komoditi->pendataanjengkol as $hargaBarangJengkol)
                                                                                    @if ($hargaBarangJengkol->tanggal_input == Carbon\Carbon::yesterday()->format('Y-m-d'))
                                                                                        @php
                                                                            ...
                                                                            <div class="col-md">
                                                                                ...
                                                                                @foreach ($komoditi->pendataanceger as $hargaBarangCeger)
                                                                                    @if ($hargaBarangCeger->tanggal_input == Carbon\Carbon::yesterday()->format('Y-m-d'))
                                                                                        @php
                                                                        ...
                                                                        <div class="row mt-4">
                                                                            <div class="col-md">
                                                                                ...
                                                                                @foreach ($komoditi->pendataancimanggis as $hargaBarangCimanggis)
                                                                                    @if ($hargaBarangCimanggis->tanggal_input == Carbon\Carbon::yesterday()->format('Y-m-d'))
                                                                                        @php
                                                                            ...
                                                                            <div class="col-md">
                                                                                ...
                                                                                @foreach ($komoditi->pendataanjombang as $hargaBarangJombang)
                                                                                    @if ($hargaBarangJombang->tanggal_input == Carbon\Carbon::yesterday()->format('Y-m-d'))
                                                                                        @php
                                                   ...
                                                   @include('backend.admin.layout.scriptRataRata')
                                            </td>
                                            <td>
                                                <a href="{{ route('pendataanAll.showSemuaPasar', $komoditi->id) }}" class="btn btn-pill btn-info"><i class="align-middle me fas fa-fw fa-file"></i></a>
                                            </td>
                                            <td>
                                                @if ($komoditi->hasInputYesterday()) <!-- Mengecek apakah sudah input hari ini -->
