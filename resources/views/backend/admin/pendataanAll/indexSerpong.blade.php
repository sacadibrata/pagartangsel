        ...
        <div class="col-md-12">
            <div class="d-md-flex justify-content-between align-items-center">
                <!-- pageheader -->
                    ...
                    <!-- button -->
                    <div>
                    <a href="{{ route('importFormPsSerpong') }}"
                            ...
                            @foreach ($komoditas as $komoditi)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @include('backend.admin.pendataanAll.priceSerpongModal')
                                    </td>
                                    <td>
                                        <a href="{{ route('pendataanAll.showSerpong', $komoditi->id) }}" class="btn btn-sm btn-info"><i class="bi bi-info-circle"></i></a>
                                    </td>
                                    <td>
