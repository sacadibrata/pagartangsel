                            ...
                            @foreach ($komoditas as $komoditi)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @include('backend.admin.pendataanstok.stokSerpongmodal')
                                    </td>
                                    <td>
                                        <a href="{{ route('pendataanStok.showAdminSerpong', $komoditi->id) }}" class="btn btn-sm btn-pill btn-info"><i class="align-middle me fas fa-fw fa-file"></i></a>
                                    </td>
                                    <td>
