    ...
    <div class="container-fluid">
        ...
        <div class="header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item" style="text-transform: capitalize;"><a href="{{ route('pendataanStok.indexAdminCimanggis') }}">Input Harga</a></li>
                    <li class="breadcrumb-item" style="text-transform: capitalize;"><a href="{{ route('pendataanStok.showAdminCimanggis', $pendataan[0]->id_komoditas) }}">Detail Komoditas</a></li>
                </ol>
            </nav>
        </div>
        <div class="row">
                            ...
                            <tbody>
                                ...
                                @foreach($pendataan as $key => $data)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('pendataanStok.destroyAdminCimanggis', $data->id_pendataan) }}" method="POST" style="display: inline-block;">
                                                @csrf
                                                @method('DELETE')
