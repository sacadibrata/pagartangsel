      ...
      <div class="row mb-8">
        <div class="col-md-12">
          <div class="d-md-flex justify-content-between align-items-center">
            ...
            <!-- button -->
            <div>
              <a href="{{ route('role.create') }}" class="btn btn-outline-primary mb-2">Add New Role</a>
            </div>
          </div>
        </div>
      </div>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <form onsubmit="return confirm('Anda yakin ingin menghapus data hak akses {{ $item->nama_role }}?')" class="d-inline" method="POST" action="{{ route('role.destroy', $item->id) }}">
                                                @csrf
                                                @method('DELETE')
