                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('satuan.index') }}" class="text-inherit">Units</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Add New Unit</li>
                            </ol>
                        </nav>
                    </div>
                    <div>
                        <a href="{{ route('satuan.index') }}" class="btn btn-outline-secondary mb-2">Back to Units</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <form action='{{ route('satuan.store') }}' method='POST'>
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-lg-12">
                                    ...
                                    <input type="text" class="form-control" placeholder="Unit Name" name="nama_satuan"  required>
                                </div>
                                <div class="col-lg-12">
