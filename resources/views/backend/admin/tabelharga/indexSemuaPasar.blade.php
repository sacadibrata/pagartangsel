        ...
        <div class="header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('tabelharga.indexSemuaPasar') }}">Tabel Harga</a></li>
                </ol>
            </nav>
        </div>
        <div class="col-12">
                        ...
                        <tbody>
                            ...
                            @foreach ($komoditas as $komoditi)
                                @if ($komoditi->kategori->nama_kategori != $currentKategori)
                                    <tr>
                                        <td colspan="7"><strong>{{ $komoditi->kategori->nama_kategori }}</strong></td>
                                    </tr>
                                    @php
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        $hargaKemarin = null;
                                        @endphp
                                        @foreach ($komoditi->pendataansemuapasar as $hargaBarang)
