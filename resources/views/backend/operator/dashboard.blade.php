@include('backend.operator.layout.header')

@include('backend.operator.layout.sidebar')
...
@include('backend.operator.layout.script')
            
@include('backend.operator.layout.footer')
