        ...
        <div class="header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" style="text-transform: capitalize;"><a href="{{ route('grafikceger.tampil', $pendataan[0]->id_komoditas) }}">Grafik Harga {{ $pendataan[0]->nama_komoditas }}</a></li>
                </ol>
            </nav>
        </div>
        <div class="col-12">
