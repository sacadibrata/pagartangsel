                            ...
                            <tbody>
                                ...
                                @foreach ($komoditas as $komoditi)
                                    ...
                                    <tr>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body ">
                                                            <div class="card">
                                                                ...
                                                                <div class="card-body">
                                                                    <form action="{{ route('pendataanPsCeger.store', $komoditi->id) }}" method="POST">
                                                                    @csrf
                                                                    <div class="row">
                                                                        <div class="col-md">
                                                                            <div class="mb-0">
                                        ...
                                        <td>
                                            <a href="{{ route('pendataanPsCeger.show', $komoditi->id) }}" class="btn btn-pill btn-info"><i class="align-middle me fas fa-fw fa-file"></i></a>
                                        </td>
