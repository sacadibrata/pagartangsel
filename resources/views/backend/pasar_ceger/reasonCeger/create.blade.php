        ...
        <div class="header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" style="text-transform: capitalize;"><a href="{{ route('reasonCeger.create') }}">Form Tambah Penyebab Kenaikan Harga</a></li>
                </ol>
            </nav>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <a class="btn btn-pill btn-sm btn-secondary" href="{{ route('reasonCeger.index') }}"> Kembali </a>
                    </div>
                    <div class="card-body">
                        <form action='{{ route('reasonCeger.store') }}' method='POST' id="validation-form">
                            @csrf
