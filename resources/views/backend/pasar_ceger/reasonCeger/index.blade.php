...
@include('backend.pasar_ceger.layout.sidebar')
        ...
        <div class="header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"style="text-transform: capitalize;"><a href="{{ route('reasonCeger.index') }}">Daftar Penyebab</a></li>
                </ol>
            </nav>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <a class="btn btn-pill btn-sm btn-secondary" href="{{ route('reasonCeger.create') }}"> Tambah </a>
                    </div>
                    <div class="card-body">
                        <table id="datatables-reponsive" class="table table-striped" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            @foreach ($item->reasonCeger as $reason)
