...
<div class="wrapper">
		<nav id="sidebar" class="sidebar">
			<a class="sidebar-brand" href="{{ route('dashboardCiputat') }}">
			...
			<div class="sidebar-content">
				...
				<ul class="sidebar-nav">
					<li class="sidebar-item">
						<a class="sidebar-link {{ ($title === "DASHBOARD") ? 'active' : '' }}" href="{{ route('dashboardCiputat') }}">
					...
					<li class="sidebar-item">
						<a class="sidebar-link {{ ($title === "INPUT HARGA") ? 'active' : '' }}" href="{{ route('pendataanPsCiputat.index') }}">
							<i class="align-middle me-2 fas fa-fw fa-cart-plus"></i> <span class="align-middle">Input Harga</span>
						</a>
					</li>
					<li class="sidebar-item">
						<a class="sidebar-link {{ ($title === "TABEL HARGA") ? 'active' : '' }}" href="{{route('tabelhargaciputat.index')}}">
							<i class="align-middle me-2 fas fa-fw fa-table"></i> <span class="align-middle">Tabel Harga</span>
						</a>
					</li>
					<li class="sidebar-item">
						<a class="sidebar-link {{ ($title === "GRAFIK") ? 'active' : '' }}" href="{{route('grafikciputat.index')}}">
					...
					<li class="sidebar-item">
						...
						<ul id="pages" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
                            ...
                            <li class="sidebar-item"><a class="sidebar-link" href="{{ route('exportciputat.index') }}">Laporan Harga</a></li>
							<li class="sidebar-item"><a class="sidebar-link" href="{{route('exportFormLaporanPilihTanggalCiputat')}}">Laporan Harga Berdasarkan Tanggal</a></li>
						</ul>
					</li>
                    <li class="sidebar-header">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link {{ ($title === "DAFTAR PENYEBAB KENAIKAN HARGA") ? 'active' : '' }}" href="{{ route('reasonCiputat.index') }}">
                    ...
                    <li class="sidebar-item">
                        ...
                        <a class="sidebar-link {{ ($title === "INPUT PENYEBAB KENAIKAN HARGA") ? 'active' : '' }}" href="{{ route('alasanCiputat.index') }}">
                    ...
                    <li class="sidebar-item">
						<form action="{{ route('logoutCiputat') }}" method="POST">
                            @csrf
					...
					<ul class="navbar-nav ms-auto">
						<li class="nav-item dropdown ms-lg-2">
							...
							<div class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
								...
								<a class="dropdown-item" href="{{ route('logoutCiputat') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="align-middle me-1 fas fa-fw fa-arrow-alt-circle-right"></i> Sign out</a>
								<form id="logout-form" action="{{ route('logoutCiputat') }}" method="POST" style="display: none;">
									@csrf
								</form>
							</div>
						</li>
