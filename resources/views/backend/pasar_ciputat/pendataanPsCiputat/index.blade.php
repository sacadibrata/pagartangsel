        ...
        <div class="header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" style="text-transform: capitalize;"><a href="{{ route('pendataanPsCiputat.index') }}">Input Harga</a></li>
                    <li class="breadcrumb-item" style="text-transform: capitalize;"><a href="{{ route('tabelhargaciputat.index') }}">Tabel Harga</a></li>
                    <li class="breadcrumb-item" style="text-transform: capitalize;"><a href="{{ route('grafikciputat.index') }}">Grafik Harga</a></li>
                </ol>
            </nav>
        </div>
        <div class="row">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <h6 class="card-subtitle text-muted">
                            <a href="{{ route('importFormCiputat') }}"
                            ...
                            <tbody>
                                ...
                                @foreach ($komoditas as $komoditi)
                                    ...
                                    <tr>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body ">
                                                            <div class="card">
                                                                ...
                                                                <div class="card-body">
                                                                    <form action="{{ route('pendataanPsCiputat.store', $komoditi->id) }}" method="POST">
                                                                    @csrf
                                                                    <div class="row">
                                                                        <div class="col-md">
                                                                            <div class="mb-0">
                                        ...
                                        <td>
                                            <a href="{{ route('pendataanPsCiputat.show', $komoditi->id) }}" class="btn btn-pill btn-info"><i class="align-middle me fas fa-fw fa-file"></i></a>
                                        </td>
