        ...
        <div class="header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" style="text-transform: capitalize;"><a href="{{ route('alasanJengkol.index') }}">Input Penyebab Kenaikan Harga</a></li>
                </ol>
            </nav>
        </div>
        <div class="col-12">
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body ">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <form action="{{ route('alasanJengkol.store', $komoditi->id) }}" method="POST">
                                                                @csrf
                                                                <div class="row">
                                                                    <div class="col-md">
                                                                        <div class="mb-0">
                                                                            ...
                                                                            <div class="input-group">
                                                                                ...
                                                                                <select class="form-control" name="reason_id">
                                                                                    ...
                                                                                    @foreach ($komoditass as $k)
                                                                                        @foreach ($k->reasonJengkol as $reason)
