    ...
    <div class="container-fluid">
        ...
        <div class="header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item" style="text-transform: capitalize;"><a href="{{ route('dashboardJengkol') }}">Dashboard</a></li>
                    <li class="breadcrumb-item" style="text-transform: capitalize;"><a href="{{ route('pendataanPsJengkol.index') }}">Input Harga</a></li>
                    <li class="breadcrumb-item" style="text-transform: capitalize;"><a href="{{ route('tabelhargaJengkol.index') }}">Tabel Harga</a></li>
                    <li class="breadcrumb-item" style="text-transform: capitalize;"><a href="{{ route('grafikJengkol.index') }}">Grafik Harga</a></li>
                </ol>
            </nav>
        </div>
        <div class="row">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <h6 class="card-subtitle text-muted">
                            <a href="{{ route('importFormJengkol') }}"
                            ...
                            <tbody>
                                ...
                                @foreach ($komoditas as $komoditi)
                                    ...
                                    <tr>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body ">
                                                            <div class="card">
                                                                ...
                                                                <div class="card-body">
                                                                    <form action="{{ route('pendataanPsJengkol.store', $komoditi->id) }}" method="POST">
                                                                    @csrf
                                                                    <div class="row">
                                                                        <div class="col-md">
                                                                            <div class="mb-0">
                                        ...
                                        <td>
                                            <a href="{{ route('pendataanPsJengkol.show', $komoditi->id) }}" class="btn btn-pill btn-info"><i class="align-middle me fas fa-fw fa-file"></i></a>
                                        </td>
