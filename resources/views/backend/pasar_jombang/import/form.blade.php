        ...
        <div class="header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" style="text-transform: capitalize;"><a href="{{ route('importFormJombang') }}">Upload Data</a></li>
                </ol>
            </nav>
        </div>
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body col-12">
                        <div class="my-2">
                            ...
                            @endif
                            <form action="{{ route('importDataJombang') }}" method="POST" enctype="multipart/form-data">
                                @csrf
