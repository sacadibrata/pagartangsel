...
<div class="wrapper">
		<nav id="sidebar" class="sidebar">
			<a class="sidebar-brand" href="{{ route('dashboardSerpong') }}">
			...
			<div class="sidebar-content">
				...
				<ul class="sidebar-nav">
					<li class="sidebar-item">
						<a class="sidebar-link {{ ($title === "DASHBOARD") ? 'active' : '' }}" href="{{ route('dashboardSerpong') }}">
					...
					<li class="sidebar-item">
						<a class="sidebar-link {{ ($title === "INPUT HARGA") ? 'active' : '' }}" href="{{ route('pendataanPsSerpong.index') }}">
							<i class="align-middle me-2 fas fa-fw fa-cart-plus"></i> <span class="align-middle">Input Harga</span>
						</a>
					</li>
					<li class="sidebar-item">
						<a class="sidebar-link {{ ($title === "TABEL HARGA") ? 'active' : '' }}" href="{{route('tabelhargaserpong.index')}}">
							<i class="align-middle me-2 fas fa-fw fa-table"></i> <span class="align-middle">Tabel Harga</span>
						</a>
					</li>
					<li class="sidebar-item">
						<a class="sidebar-link {{ ($title === "GRAFIK") ? 'active' : '' }}" href="{{route('grafikserpong.index')}}">
					...
					<li class="sidebar-item">
						...
						<ul id="pages" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
                            ...
                            <li class="sidebar-item"><a class="sidebar-link" href="{{ route('exportserpong.index') }}">Laporan Harga</a></li>
							<li class="sidebar-item"><a class="sidebar-link" href="{{route('exportFormLaporanPilihTanggalSerpong')}}">Laporan Harga Berdasarkan Tanggal</a></li>
						</ul>
					</li>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link {{ ($title === "DAFTAR PENYEBAB KENAIKAN HARGA") ? 'active' : '' }}" href="{{ route('reasonSerpong.index') }}">
                    ...
                    <li class="sidebar-item">
                        ...
                        <a class="sidebar-link {{ ($title === "INPUT PENYEBAB KENAIKAN HARGA") ? 'active' : '' }}" href="{{ route('alasanSerpong.index') }}">
                    ...
                    <li class="sidebar-item">
                        <form action="{{ route('logoutSerpong') }}" method="POST">
                            @csrf
					...
					<ul class="navbar-nav ms-auto">
						<li class="nav-item dropdown ms-lg-2">
							...
							<div class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
								...
								<a class="dropdown-item" href="{{ route('logoutSerpong') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="align-middle me-1 fas fa-fw fa-arrow-alt-circle-right"></i> Sign out</a>
								<form id="logout-form" action="{{ route('logoutSerpong') }}" method="POST" style="display: none;">
									@csrf
								</form>
							</div>
						</li>
