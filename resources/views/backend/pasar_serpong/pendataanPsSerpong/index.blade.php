                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <h6 class="card-subtitle text-muted">
                            <a href="{{ route('importFormSerpong') }}"
                            ...
                            <tbody>
                                ...
                                @foreach ($komoditas as $komoditi)
                                    ...
                                    <tr>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body ">
                                                            <div class="card">
                                                                ...
                                                                <div class="card-body">
                                                                    <form action="{{ route('pendataanPsSerpong.store', $komoditi->id) }}" method="POST">
                                                                    @csrf
                                                                    <div class="row">
                                                                        <div class="col-md">
                                                                            <div class="mb-0">
                                        ...
                                        <td>
                                            <a href="{{ route('pendataanPsSerpong.show', $komoditi->id) }}" class="btn btn-pill btn-info"><i class="align-middle me fas fa-fw fa-file"></i></a>
                                        </td>
