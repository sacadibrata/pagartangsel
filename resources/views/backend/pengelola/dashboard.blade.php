@include('backend.pengelola.layout.header')

@include('backend.pengelola.layout.sidebar')
...
@include('backend.pengelola.layout.script')
            
@include('backend.pengelola.layout.footer')
