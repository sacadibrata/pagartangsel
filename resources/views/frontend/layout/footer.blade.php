    ...
    <div class="container">
      <div class="row align-items-center ">
          <div class="col-8 col-md-12 col-lg-4">
              <a href="#">
                <img src="{{ asset('dist/assets/images/logo/logo_tangsel.png') }}" style="width: 40px; height : 40px" alt="eCommerce HTML Template">&nbsp;&nbsp;
                    <img src="{{ asset('dist/assets/images/logo/logo_pagar.png') }}" style="width: 200px; height :63px" alt="eCommerce HTML Template">
              </a>
          </div>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6 text-end mb-2 mb-lg-0">
            <ul class="list-inline mb-0">
              ...
              <li class="list-inline-item">
                <a href="#!"><img src="{{ asset('dist/assets/images/payment/amazonpay.svg') }}" alt=""></a>
              </li>
              <li class="list-inline-item">
                <a href="#!"><img src="{{ asset('dist/assets/images/payment/american-express.svg') }}" alt=""></a>
              </li>
              <li class="list-inline-item">
                <a href="#!"><img src="{{ asset('dist/assets/images/payment//mastercard.svg') }}" alt=""></a>
              </li>
              <li class="list-inline-item">
                <a href="#!"><img src="{{ asset('dist/assets/images/payment/paypal.svg') }}" alt=""></a>
              </li>
              <li class="list-inline-item">
                <a href="#!"><img src="{{ asset('dist/assets/images/payment/visa.svg') }}" alt=""></a>
              </li>
            </ul>
          </div>
